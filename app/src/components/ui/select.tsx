...
function SelectItem({
  ...
  // Check if custom highlight styles are provided
  const hasCustomHighlight = className?.includes('hover:') || className?.includes('focus:') || className?.includes('data-[highlighted]');
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        // Default highlight styles - only apply if no custom styles provided
        !hasCustomHighlight && "data-[highlighted]:bg-accent data-[highlighted]:text-accent-foreground",
        className
      )}
      {...props}
    >
